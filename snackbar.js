...
**/
/**
 * This script works and provides methods to customize and display a snacbar in your html pages.
 * The following steps are to be followed for each html document of yours you want to display message as 
 * bottom snackbar.
 * 
 * Steps:
 * 1) Include this script in your html document in head section, before you include any other script of yours.
 * 2) Include the snackbar.css in your html document in head section.
 * 3) Copy the code from snackbar.html and paste it at the bottom of your <body> tag but before closing it.
 * 4) Call the methods defined in this script from your associated scripts to make snackbar work.
 */
